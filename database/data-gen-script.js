...
const getHouses = function() {
  (async() => {
      housesFile.write('title,isEntirePlace,location,host_name,host_photo,rating,description,space_description,guest_description,other_description,amenity1,amenity2,amenity3,amenity4\n')
...
const getBedrooms = function() {
    (async() => {
      bedroomsFile.write('houseId,numberOfGuests,bathroom,bedsize,bed2size\n');
